...
function sm.scrapcomputers.config.createDefaultConfigs(onlyDefaultConfigs)
    ...
    local config = {
        ...
        },
        {
            ...
            description = "If the setting is configured to Everyone, then anyone can access the configurator. Otherwise, access is restricted to the host only.",
            selectedOption = 1,
            hostOnly = true,
        ...
        },
        {
            ...
            description = "This option allows you to set a limit on the number of hologram objects that can be rendered per hologram.\n\nYou can choose from the following options: Unlimited, 16, 32, 64, 128, 256, 512, 1024, 2048, and 4096",
            selectedOption = 1,
            hostOnly = false,
        ...
        },
        {
            ...
            name = "Automaticly Save code (Auto-Save)",
            description = "This feature will automatically save your code whenever you exit the GUI, ensuring that no changes or updates are lost and providing a seamless and worry-free experience as you code.",
            selectedOption = 1,
            hostOnly = false,
        ...
        },
        {
            ...
            name = "Clear error on restart",
            description = "When you get a error message, it stops the computer and you will have to press Done to clear the error and the computer would start. If you enable this, afther you get a error, restarting the computer (turning it off and on) will clear the error and start up again.",
            selectedOption = 2,
            hostOnly = false,
            options = {"Disabled", "Enabled"}
        },
...
local managers = {"EnvManager", "ComponentManager", "FontManager"}
