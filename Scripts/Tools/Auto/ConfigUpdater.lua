...
---@class ConfigUpdaterClass : ToolClass
ConfigUpdaterClass = class()

function ConfigUpdaterClass:server_onCreate()
    sm.scrapcomputers.config.initConfig()
    sm.scrapcomputers.config.__tool = self.tool
...
function ConfigUpdaterClass:server_onFixedUpdate()
...
function ConfigUpdaterClass:server_onRefresh() self:server_onCreate() end

function ConfigUpdaterClass:sv_updateConfig()
